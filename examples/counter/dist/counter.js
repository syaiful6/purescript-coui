...
(function(exports) {
  ...
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  var Data_Functor = PS["Data.Functor"];        
  var zap = function (pairing) {
      return pairing(Data_Function.apply);
  };
  var sym = function (pairing) {
      return function (f) {
          return function (ga) {
              return function (fb) {
                  return pairing(Data_Function.flip(f))(fb)(ga);
              };
          };
      };
  };
  var freeCofree = function (dictFunctor) {
      return function (dictFunctor1) {
          return function (pairing) {
              return function (f) {
                  return function ($49) {
                      return Control_Comonad_Cofree.explore(dictFunctor)(dictFunctor1)(zap(pairing))(Data_Functor.map(Control_Monad_Free.freeFunctor)(f)($49));
                  };
              };
          };
      };
  };
  exports["freeCofree"] = freeCofree;
  exports["sym"] = sym;
  exports["zap"] = zap;
})(PS["Data.Functor.Pairing"] = PS["Data.Functor.Pairing"] || {});
(function(exports) {
  // Generated by psc version 0.10.5
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var Control_Monad = PS["Control.Monad"];
  var Data_Unit = PS["Data.Unit"];
  var runCo = function (v) {
      return v;
  };
  var pairCo = function (dictFunctor) {
      return function (f) {
          return function (w) {
              return function (cow) {
                  return runCo(cow)(Data_Functor.map(dictFunctor)(f)(w));
              };
          };
      };
  };
  var liftCo = function (dictComonad) {
      return function (f) {
          return Control_Apply.apply(Control_Apply.applyFn)(Control_Comonad.extract(dictComonad))(f);
      };
  };
  var functorCo = function (dictFunctor) {
      return new Data_Functor.Functor(function (f) {
          return function (v) {
              return function (w) {
  ...
  var applyCo = function (dictExtend) {
      return new Control_Apply.Apply(function () {
          return functorCo(dictExtend["__superclass_Data.Functor.Functor_0"]());
      }, function (v) {
          return function (v1) {
              return function (w) {
  ...
  var bindCo = function (dictExtend) {
      return new Control_Bind.Bind(function () {
          return applyCo(dictExtend);
      }, function (v) {
          return function (f) {
              return function (w) {
  ...
  var applicativeCo = function (dictComonad) {
      return new Control_Applicative.Applicative(function () {
          return applyCo(dictComonad["__superclass_Control.Extend.Extend_0"]());
      }, function (a) {
          return function (w) {
  ...
  var monadCo = function (dictComonad) {
      return new Control_Monad.Monad(function () {
          return applicativeCo(dictComonad);
      }, function () {
          return bindCo(dictComonad["__superclass_Control.Extend.Extend_0"]());
      });
  };
  var monadStateCo = function (dictComonadStore) {
      return new Control_Monad_State_Class.MonadState(function () {
          return monadCo(dictComonadStore["__superclass_Control.Comonad.Comonad_0"]());
      }, function (f) {
          return Control_Bind.bind(bindCo((dictComonadStore["__superclass_Control.Comonad.Comonad_0"]())["__superclass_Control.Extend.Extend_0"]()))(liftCo(dictComonadStore["__superclass_Control.Comonad.Comonad_0"]())(Control_Comonad_Store_Class.pos(dictComonadStore)))(function (v) {
              var $32 = f(v);
              return function (w) {
                  return Control_Comonad_Store_Class.peek(dictComonadStore)($32.value1)(w)($32.value0);
              };
          });
      });
  };
  exports["liftCo"] = liftCo;
  exports["pairCo"] = pairCo;
  exports["runCo"] = runCo;
  exports["functorCo"] = functorCo;
  exports["applyCo"] = applyCo;
  exports["applicativeCo"] = applicativeCo;
  exports["bindCo"] = bindCo;
  exports["monadCo"] = monadCo;
  exports["monadStateCo"] = monadStateCo;
})(PS["Data.Functor.Pairing.Co"] = PS["Data.Functor.Pairing.Co"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var Data_Functor_Pairing = PS["Data.Functor.Pairing"];
  var Data_Functor_Pairing_Co = PS["Data.Functor.Pairing.Co"];
  var Data_Profunctor = PS["Data.Profunctor"];
  ...
  var Data_Identity = PS["Data.Identity"];
  var Control_Comonad_Store_Trans = PS["Control.Comonad.Store.Trans"];
  var spec = function (performAction) {
      return function (pair) {
  ...
  var simpleSpec = function (dictFunctor) {
      return function (performAction) {
          return function (space) {
              return {
                  space: space, 
                  performAction: performAction, 
                  pair: Data_Functor_Pairing.sym(Data_Functor_Pairing_Co.pairCo(dictFunctor))
              };
          };
      };
  };
  var explore = function (dictMonad) {
      return Control_Coroutine.emit(dictMonad);
  };
  var createReactSpec$prime = function (dictComonad) {
      return function (wrap) {
          return function (v) {
              var dispatcher = function ($$this) {
                  return function (action) {
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                          var producer = v.performAction(action);
                          var consumer = Control_Monad_Rec_Class.forever(Control_Monad_Free_Trans.monadRecFreeT(Control_Coroutine.functorAwait)(Control_Monad_Aff.monadAff))(Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorAwait)(Control_Monad_Aff.monadAff))(Control_Coroutine["await"](Control_Monad_Aff.monadAff))(function (v1) {
                              return Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorAwait))(Control_Monad_Aff.monadAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Unsafe.unsafeCoerceEff(React.transformState($$this)(function ($92) {
                                  return v.pair(Data_Function["const"](Control_Category.id(Control_Category.categoryFn)))(v1)(Control_Extend.duplicate(dictComonad["__superclass_Control.Extend.Extend_0"]())($92));
                              }))));
                          }));
                          return Control_Monad_Eff_Unsafe.unsafeCoerceEff(Control_Monad_Aff.launchAff(Control_Coroutine.runProcess(Control_Monad_Aff.monadRecAff)(Control_Coroutine.connect(Control_Monad_Aff.monadRecAff)(Control_Monad_Aff.parallelParAff)(producer)(consumer))));
                      })());
                  };
              };
              var render = function ($$this) {
                  return function __do() {
                      ...
                      return wrap(Control_Comonad.extract(dictComonad)(v1)(dispatcher($$this)));
                  };
              };
              return {
                  spec: React.spec(v.space)(render), 
                  dispatch: dispatcher
              };
          };
      };
  };
  var createReactSpec = function (dictComonad) {
      return createReactSpec$prime(dictComonad)(React_DOM["div'"]);
  };
  var createClass = function (dictComonad) {
      return function (spec$prime) {
          return React.createClass((function (v) {
              return v.spec;
          })(createReactSpec(dictComonad)(spec$prime)));
      };
  };
      ...
      return function (space) {
          return function (el) {
              return Data_Functor["void"](Control_Monad_Aff.functorAff)((function () {
                  var ui = createClass(dictComonad)(space);
                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(ReactDOM.render(React.createFactory(ui)({}))(DOM_HTML_Types.htmlElementToElement(el)));
              })());
          };
      };
  };
  var combine$prime = function (dictComonad) {
      return function (dictComonad1) {
          return function (dictMonad) {
              return function (cobuild) {
                  return function (v) {
                      return function (v1) {
                          var performAction = function (v2) {
                              if (v2 instanceof Data_Either.Left) {
                                  return Control_Monad_Free_Trans.interpret(Control_Coroutine.functorEmit)(((dictMonad["__superclass_Control.Bind.Bind_1"]())["__superclass_Control.Apply.Apply_0"]())["__superclass_Data.Functor.Functor_0"]())(function (v3) {
                                      var modifyFirst = Control_Monad_State_Class.modify(Data_Functor_Pairing_Co.monadStateCo(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity)))(function (rc) {
                                          var $61 = {};
                                          for (var $62 in rc) {
                                              if ({}.hasOwnProperty.call(rc, $62)) {
                                                  $61[$62] = rc[$62];
                                              };
                                          };
                                          $61.first = v.pair(Data_Function["const"](Control_Category.id(Control_Category.categoryFn)))(v3.value0)(Control_Extend.duplicate(dictComonad["__superclass_Control.Extend.Extend_0"]())(rc.first));
                                          return $61;
                                      });
                                      return new Control_Coroutine.Emit(modifyFirst, v3.value1);
                                  })(v.performAction(v2.value0));
                              };
                              if (v2 instanceof Data_Either.Right) {
                                  return Control_Monad_Free_Trans.interpret(Control_Coroutine.functorEmit)(((dictMonad["__superclass_Control.Bind.Bind_1"]())["__superclass_Control.Apply.Apply_0"]())["__superclass_Data.Functor.Functor_0"]())(function (v3) {
                                      var modifySecond = Control_Monad_State_Class.modify(Data_Functor_Pairing_Co.monadStateCo(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity)))(function (rc) {
                                          var $68 = {};
                                          for (var $69 in rc) {
                                              if ({}.hasOwnProperty.call(rc, $69)) {
                                                  $68[$69] = rc[$69];
                                              };
                                          };
                                          $68.second = v1.pair(Data_Function["const"](Control_Category.id(Control_Category.categoryFn)))(v3.value0)(Control_Extend.duplicate(dictComonad1["__superclass_Control.Extend.Extend_0"]())(rc.second));
                                          return $68;
                                      });
                                      return new Control_Coroutine.Emit(modifySecond, v3.value1);
                                  })(v1.performAction(v2.value0));
                              };
                              throw new Error("Failed pattern match at Coui.Component line 215, column 21 - line 225, column 31: " + [ v2.constructor.name ]);
                          };
                          var build = function (v2) {
                              return cobuild(Data_Profunctor.lmap(Data_Profunctor.profunctorFn)(function (v3) {
                                  return function ($93) {
                                      return v3(Data_Either.Left.create($93));
                                  };
                              })(Control_Comonad.extract(dictComonad)(v2.first)))(Data_Profunctor.lmap(Data_Profunctor.profunctorFn)(function (v3) {
                                  return function ($94) {
                                      return v3(Data_Either.Right.create($94));
                                  };
                              })(Control_Comonad.extract(dictComonad1)(v2.second)));
                          };
                          return {
                              space: Control_Comonad_Store.store(build)({
                                  first: v.space, 
                                  second: v1.space
                              }), 
                              pair: Data_Functor_Pairing.sym(Data_Functor_Pairing_Co.pairCo(Control_Comonad_Store_Trans.functorStoreT(Data_Identity.functorIdentity))), 
                              performAction: performAction
                          };
                      };
                  };
  ...
  var selectElement = function (query) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(Control_Bind.composeKleisliFlipped(Control_Monad_Eff.bindEff)(function ($8) {
          ...
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)((function () {
              ...
              throw new Error("Failed pattern match at Coui.Util line 53, column 8 - line 55, column 88: " + [ v.constructor.name ]);
          })());
      });
  };
...
(function(exports) {
  ...
  var TwoButton = (function () {
      function TwoButton(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      TwoButton.create = function (value0) {
          return function (value1) {
              return new TwoButton(value0, value1);
          };
      };
      return TwoButton;
  })();
  ...
  var pairUpDownTwoButton = function (f) {
      return function (v) {
          return function (v1) {
              if (v instanceof Up) {
                  return f(v.value0)(v1.value0);
              };
              if (v instanceof Down) {
                  return f(v.value0)(v1.value1);
              };
              throw new Error("Failed pattern match at Counter.Cofree line 26, column 1 - line 26, column 53: " + [ f.constructor.name, v.constructor.name, v1.constructor.name ]);
          };
      };
  };
  var functorUpDown = new Data_Functor.Functor(function (f) {
      return function (m) {
          if (m instanceof Up) {
              return new Up(f(m.value0));
          };
          if (m instanceof Down) {
              return new Down(f(m.value0));
          };
          throw new Error("Failed pattern match at Counter.Cofree line 20, column 1 - line 20, column 48: " + [ m.constructor.name ]);
      };
  });
  var functorTwo = new Data_Functor.Functor(function (f) {
      return function (m) {
          return new TwoButton(f(m.value0), f(m.value1));
      };
  });
  var ui = function (initial) {
      var twoButton = function (state) {
          return new TwoButton(state + 1 | 0, state - 1);
      };
      var render = function (state) {
          return function (send) {
              return [ React_DOM["p'"]([ React_DOM.text("The state is: "), React_DOM.text(Data_Show.show(Data_Show.showInt)(state)) ]), React_DOM.p([ React_DOM_Props.className("btn-group") ])([ React_DOM.button([ React_DOM_Props.className("btn btn-success"), React_DOM_Props.onClick(function (v) {
                  return send(Increment.value);
              }) ])([ React_DOM.text("+") ]), React_DOM.button([ React_DOM_Props.className("btn btn-danger"), React_DOM_Props.onClick(function (v) {
                  return send(Decrement.value);
              }) ])([ React_DOM.text("-") ]) ]) ];
          };
      };
      return Control_Comonad_Cofree.unfoldCofree(functorTwo)(initial)(render)(twoButton);
  };
  var delay = function (ms) {
      return Control_Monad_Aff["later'"](ms)(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit));
  };
  var performAction = function (v) {
      if (v instanceof Increment) {
          return Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorEmit)(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorEmit))(Control_Monad_Aff.monadAff)(delay(500)))(function () {
              return Data_Functor["void"](Control_Monad_Free_Trans.functorFreeT(Control_Coroutine.functorEmit)(Control_Monad_Aff.functorAff))(Coui_Component.explore(Control_Monad_Aff.monadAff)(Control_Monad_Free.liftF(new Up(Data_Unit.unit))));
          });
      };
      if (v instanceof Decrement) {
          return Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorEmit)(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorEmit))(Control_Monad_Aff.monadAff)(delay(500)))(function () {
              return Data_Functor["void"](Control_Monad_Free_Trans.functorFreeT(Control_Coroutine.functorEmit)(Control_Monad_Aff.functorAff))(Coui_Component.explore(Control_Monad_Aff.monadAff)(Control_Monad_Free.liftF(new Down(Data_Unit.unit))));
          });
      };
      throw new Error("Failed pattern match at Counter.Cofree line 56, column 1 - line 58, column 37: " + [ v.constructor.name ]);
  };
  var counterCofree = function (initial) {
      return Coui_Component.spec(performAction)(Data_Functor_Pairing.freeCofree(functorUpDown)(functorTwo)(pairUpDownTwoButton))(ui(initial));
  };
  exports["Increment"] = Increment;
  exports["Decrement"] = Decrement;
  exports["TwoButton"] = TwoButton;
  exports["Up"] = Up;
  exports["Down"] = Down;
  exports["counterCofree"] = counterCofree;
  exports["delay"] = delay;
  exports["pairUpDownTwoButton"] = pairUpDownTwoButton;
  exports["performAction"] = performAction;
  exports["ui"] = ui;
  exports["functorUpDown"] = functorUpDown;
  exports["functorTwo"] = functorTwo;
})(PS["Counter.Cofree"] = PS["Counter.Cofree"] || {});
(function(exports) {
  // Generated by psc version 0.10.5
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var ui = function (s) {
      ...
      return Control_Comonad_Store.store(render)(s);
  };
  var performAction = function (dictMonad) {
      return function (v) {
          if (v instanceof Increment) {
              return Data_Functor["void"](Control_Monad_Free_Trans.functorFreeT(Control_Coroutine.functorEmit)(((dictMonad["__superclass_Control.Bind.Bind_1"]())["__superclass_Control.Apply.Apply_0"]())["__superclass_Data.Functor.Functor_0"]()))(Coui_Component.explore(dictMonad)(Control_Monad_State_Class.modify(Data_Functor_Pairing_Co.monadStateCo(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity)))(Data_Semiring.add(Data_Semiring.semiringInt)(1))));
          };
          if (v instanceof Decrement) {
              return Data_Functor["void"](Control_Monad_Free_Trans.functorFreeT(Control_Coroutine.functorEmit)(((dictMonad["__superclass_Control.Bind.Bind_1"]())["__superclass_Control.Apply.Apply_0"]())["__superclass_Data.Functor.Functor_0"]()))(Coui_Component.explore(dictMonad)(Control_Monad_State_Class.modify(Data_Functor_Pairing_Co.monadStateCo(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity)))(function (v1) {
                  return v1 - 1;
              })));
          };
          throw new Error("Failed pattern match at Counter.Store line 38, column 1 - line 38, column 60: " + [ v.constructor.name ]);
      };
  };
  var counterStore = function (dictMonad) {
      return function (initial) {
          return Coui_Component.simpleSpec(Control_Comonad_Store_Trans.functorStoreT(Data_Identity.functorIdentity))(performAction(dictMonad))(ui(initial));
      };
  };
  exports["Increment"] = Increment;
  exports["Decrement"] = Decrement;
  ...
  exports["performAction"] = performAction;
  exports["ui"] = ui;
})(PS["Counter.Store"] = PS["Counter.Store"] || {});
(function(exports) {
  // Generated by psc version 0.10.5
  "use strict";
  var Prelude = PS["Prelude"];
  ...
  var React_DOM = PS["React.DOM"];
  var Coui = PS["Coui"];
  var Counter_Cofree = PS["Counter.Cofree"];
  var Counter_Store = PS["Counter.Store"];
  var Coui_Util = PS["Coui.Util"];
  var Coui_Component = PS["Coui.Component"];
  var Control_Comonad_Cofree = PS["Control.Comonad.Cofree"];
  var Control_Comonad_Store_Trans = PS["Control.Comonad.Store.Trans"];
  var Data_Identity = PS["Data.Identity"];
  ...
  var Data_Semigroup = PS["Data.Semigroup"];
  var Control_Bind = PS["Control.Bind"];        
  var main = Coui_Util.runCoUIAff((function () {
      var testCombined = function (i) {
          return Coui_Component["combine'"](Control_Comonad_Cofree.comonadCofree(Counter_Cofree.functorTwo))(Control_Comonad_Store_Trans.comonadStoreT(Data_Identity.comonadIdentity))(Control_Monad_Aff.monadAff)(function (x) {
              return function (y) {
                  return function (s) {
                      return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ React_DOM["h1'"]([ React_DOM.text("Cofree") ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(x(s))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ React_DOM["h1'"]([ React_DOM.text("Store") ]) ])(y(s))));
                  };
              };
          })(Counter_Cofree.counterCofree(i))(Counter_Store.counterStore(Control_Monad_Aff.monadAff)(i));
      };
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Coui_Util.awaitLoad)(function () {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Coui_Util.selectElement("#app"))(function (v) {
              if (v instanceof Data_Maybe.Nothing) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error("could not find #app"));
              };
              if (v instanceof Data_Maybe.Just) {
                  return Coui_Component.runUI(Control_Comonad_Store_Trans.comonadStoreT(Data_Identity.comonadIdentity))(testCombined(0))(v.value0);
              };
              throw new Error("Failed pattern match at Main line 28, column 3 - line 30, column 39: " + [ v.constructor.name ]);
          });
      });
  })());
  exports["main"] = main;
...
},{"react":159,"react-dom":29,"react-dom/server":30}]},{},[160]);
